...
初次装载`HaE Network`会从Jar包中加载离线的规则库，如果更新可以点击`Reinit`进行重新初始化。内置规则库地址可以在Github上找到：`https://github.com/overspace-labs/HaENet/blob/main/src/main/resources/rules/Rules.yml`。
